...
<body class="bg-light">
        ...
        <div class="row ms-1">
          <div class="col mt-5 bg-white shadow-sm p-4 rounded">
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editPrivacyPolicyModal">
  ...
  <div class="modal fade" id="editPrivacyPolicyModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?php echo url("/admin/privacy/policy/update"); ?>">
            ...
            <div class="form-group mb-3">
              ...
              <textarea class="form-control" id="editPrivacyPolicy" name="data" cols="30" rows="6"><?php echo $data["data"]; ?></textarea>
            </div>
